        ...
        <div className="container">
          <div className="nosotros-content">
            ...
            <div className="nosotros-text">
              ...
              <p>
                En <strong>Wine & Cheese</strong> celebramos la armonía entre vinos selectos y
                quesos artesanales. Creamos momentos memorables con maridajes para todos los gustos.
              </p>
              <p>Te esperamos con experiencias guiadas, catas y un ambiente diseñado para disfrutar.</p>
            </div>
