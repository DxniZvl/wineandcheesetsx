// updateWineImages.ts - Script para actualizar las imágenes de vinos en Supabase
...
async function updateWineImages() {
    ...
    const imagnesPath = path.join(__dirname, 'public', 'Imagenes Wine', 'vinos')
    const imageFiles = fs.readdirSync(imagnesPath)
